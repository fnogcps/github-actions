...
describe('Join Two Portions of a Path (unit tests)\n', () => {
    it('[Test 1] Expected: "portion1/portion2"', () =>
      assert.strictEqual(e.joinPath("portion1", "portion2"), "portion1/portion2")
    );
    ...
    it('[Test 21] Expected: "F4tBPmoV/Lv18joOw"', () =>
      assert.strictEqual(e.joinPath("F4tBPmoV", "Lv18joOw"), "F4tBPmoV/Lv18joOw")
    );
    ...
    assert.strictEqual(e.joinPath("1h1gRAxu", "apQtQYgl"), "1h1gRAxu/apQtQYgl")
  );
    ...
    assert.strictEqual(e.joinPath("M6c7OnQI", "nj-CEAqV"), "M6c7OnQI/nj-CEAqV")
  );
